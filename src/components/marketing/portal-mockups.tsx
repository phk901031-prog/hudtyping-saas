...
// natmalgi-demo.tsx 의 다크(bg-ink)+screen-grid 톤을 그대로 계승해서, 제네릭 아이콘
// 대신 "실제 화면처럼 보이는" 목업으로 각 카테고리가 뭘 하는 곳인지 보여준다.
  ...
  return (
    <PanelShell accentClass="bg-accent">
      <div className="flex items-center justify-between border-b border-white/10 pb-3">
        ...
        <span className="rounded bg-accent/22 px-2 py-0.5 text-[10px] font-bold text-[#bff6ef]">
          커서 앞 검색
        </span>
      </div>
...
export function StudyStenoMockup() {
  return (
    <PanelShell accentClass="bg-success">
      ...
      <div className="mt-3 flex-1">
        <p className="ko-copy text-xs leading-6 text-white/78">
