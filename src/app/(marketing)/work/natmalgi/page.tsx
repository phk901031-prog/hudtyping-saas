// src/app/(marketing)/work/natmalgi/page.tsx
// Work Steno · 낱말지기 상세 랜딩 페이지.
// 이전에 홈 (/) 하단에 있던 낱말지기 스토리(히어로 · 시작하기 · 작동방식 · 특징 · 지원 · 업데이트 · FAQ)를
// 통째로 여기로 이동. 홈은 이제 3-카테고리 포털만 남음.
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/work/natmalgi" },
  openGraph: {
    type: "website",
    locale: "ko_KR",
    url: "/work/natmalgi",
